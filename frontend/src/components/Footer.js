...
function Footer() {
  return (
    ...
    <div class="container-fluid">
      ...
      <a href="https://github.com/cmurphy20-CVTC/npi_registry_nodejs" target="_blank" rel="noreferrer"><i class="social-icon fab fa-instagram fa-2x"></i></a>
      <a href="mailto:cmurphymwdf@gmail.com" target="_blank" rel="noreferrer"><i class="social-icon fas fa-envelope fa-2x"></i></a>
      <p>© Copyright 2023 NPI Registry</p>
    </div>
